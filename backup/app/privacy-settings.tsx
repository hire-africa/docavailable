                ...
                <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
                    ...
                    {renderSection(
                        ...
                        <View style={styles.sectionContent}>
                            ...
                            {renderToggleItem(
                                ...
                                (value) => handleToggle('profileVisibility', 'showToPatients', value),
                                'profileVisibility',
                                'showToPatients'
                            )}
                            {renderToggleItem(
                                'Show to Public',
                                'Allow your profile to be visible in public searches',
                                settings.profileVisibility.showToPublic,
                                (value) => handleToggle('profileVisibility', 'showToPublic', value),
                                'profileVisibility',
                                'showToPublic'
                            )}
                            {renderToggleItem(
                                'Show Contact Information',
                                'Display your phone number and email to authorized users',
                                settings.profileVisibility.showContactInfo,
                                (value) => handleToggle('profileVisibility', 'showContactInfo', value),
                                'profileVisibility',
                                'showContactInfo'
                            )}
                            {renderToggleItem(
                                'Show Health Information',
                                'Share your health history and medical information',
                                settings.profileVisibility.showHealthInfo,
                                (value) => handleToggle('profileVisibility', 'showHealthInfo', value),
                                'profileVisibility',
                                'showHealthInfo'
                            )}
                        </View>,
                    ...
                    {renderSection(
                        ...
                        <View style={styles.sectionContent}>
                            ...
                            {renderToggleItem(
                                'Partner Sharing',
                                'Share data with trusted healthcare partners',
                                settings.dataSharing.shareWithPartners,
                                (value) => handleToggle('dataSharing', 'shareWithPartners', value),
                                'dataSharing',
                                'shareWithPartners'
                            )}
                        </View>,
