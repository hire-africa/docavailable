...
interface Step1Props {
    ...
    setHealthHistory: (history: string) => void;
    email: string;
    ...
    return (
        <ScrollView style={styles.stepContainer} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.formSection}>
                ...
                <Text style={styles.inputLabel}>Health History (Optional)</Text>
                <TextInput
                    style={[styles.input, styles.multilineInput]}
                    placeholder="Any medical conditions, allergies, or relevant health information..."
                    placeholderTextColor="#999"
                    multiline
                    numberOfLines={4}
                    value={healthHistory}
