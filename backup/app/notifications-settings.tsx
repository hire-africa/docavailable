                    ...
                    {renderSection(
                        ...
                        <View style={styles.sectionContent}>
                            {renderToggleItem(
                                ...
                                settings.health.updates,
                                (value) => handleToggle('health', 'updates', value),
                                'health',
                                'updates'
                            )}
                            {renderToggleItem(
                                ...
                                settings.health.testResults,
                                (value) => handleToggle('health', 'testResults', value),
                                'health',
                                'testResults'
                            )}
                            {renderToggleItem(
                                ...
                                settings.health.medicationReminders,
                                (value) => handleToggle('health', 'medicationReminders', value),
                                'health',
                                'medicationReminders'
                            )}
                            {renderToggleItem(
                                ...
                                settings.health.healthTips,
                                (value) => handleToggle('health', 'healthTips', value),
                                'health',
                                'healthTips'
                            )}
                        </View>,
                    ...
                    <View style={styles.quickActionsSection}>
                        <TouchableOpacity style={styles.quickActionButton} onPress={() => {
                            ...
                            const allOn = {
                                ...
                                health: { updates: true, testResults: true, medicationReminders: true, healthTips: true },
                        ...
                        <TouchableOpacity style={styles.quickActionButton} onPress={() => {
                            ...
                            const allOff = {
                                ...
                                health: { updates: false, testResults: false, medicationReminders: false, healthTips: false },
