...
const oldProblematicSection = `          {/* Audio Call Button - Only patients can initiate calls */}
...
const newFixedSection = `          {/* Audio Call Button - Only patients can initiate calls */}
          {user?.user_type === 'patient' && (
            <TouchableOpacity 
              style={{ 
                padding: 8,
...
content = content.replace(oldProblematicSection, newFixedSection);

// Write back to file
fs.writeFileSync(filePath, content);
console.log('Fixed the call button section completely');
