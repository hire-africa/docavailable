...
export default function BlogArticle6() {
  ...
  const handleShare = async () => {
    try {
      await Share.share({
        message: 'Check out this great article from DocAvailable: From Couch to 5K: Building Fitness Habits That Actually Stick',
        url: 'https://docavailable.com/blog/couch-to-5k-fitness-habits',
      });
    } catch (error) {
