...
export default function BlogArticle4() {
  ...
  const handleShare = async () => {
    try {
      await Share.share({
        message: 'Check out this great article from DocAvailable: Coping with Stress and Anxiety: Tips to Manage It in Everyday Life',
        url: 'https://docavailable.com/blog/coping-stress-anxiety',
      });
    } catch (error) {
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.articleContainer}>
          ...
          <View style={styles.articleBody}>
            ...
            <View style={styles.techniqueCard}>
              <View style={styles.techniqueHeader}>
                <Icon name="comments" size={14} color="#4CAF50" />
