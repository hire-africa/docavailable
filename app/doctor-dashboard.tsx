        ...
        <View style={styles.sidebarOverlay}>
          ...
          >
            <ScrollView
              ...
              contentContainerStyle={[styles.sidebarContent, { paddingTop: insets.top + 10, paddingBottom: insets.bottom + 20, flexGrow: 1, paddingHorizontal: 0 }]}
              showsVerticalScrollIndicator={false}
              bounces={true}
            ...
            >
              <View style={{ flexGrow: 1 }}>
                ...
                >
                  <Icon name="close" size={24} color="#A8AAAE" />
                </TouchableOpacity>

                {/* Profile Header */}
                <View style={[styles.sidebarHeader, { borderBottomWidth: 0, alignItems: 'flex-start', paddingLeft: 0, marginTop: 40, marginBottom: 24 }]}>
                  <View style={{
                    flexDirection: 'row',
                    alignItems: 'center',
                    marginBottom: 24,
                    ...
                    {user?.profile_picture_url ? (
                      <Image source={{ uri: user.profile_picture_url }} style={{ width: 60, height: 60, borderRadius: 30, borderWidth: 2, borderColor: '#B4FF3C' }} />
                    ) : user?.profile_picture ? (
                      <Image source={{ uri: user.profile_picture }} style={{ width: 60, height: 60, borderRadius: 30, borderWidth: 2, borderColor: '#B4FF3C' }} />
                    ) : (
                      <View style={{ width: 60, height: 60, borderRadius: 30, backgroundColor: '#222528', alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: '#B4FF3C' }}>
                        <FontAwesome name="user-md" size={28} color="#B4FF3C" />
                      </View>
                    )}
                    <View style={{ marginLeft: 16 }}>
                      <Text style={{ color: '#F2F2F2', fontSize: 20, fontWeight: '600', marginBottom: 4 }}>Hello,</Text>
                      <Text style={{ color: '#A3A5A8', fontSize: 14 }}>{userData?.display_name || user?.display_name || 'Doctor'}</Text>
                    </View>
                  </View>

                  {/* Theme Toggle */}
                  <View style={{ width: '100%' }}>
                    <Text style={{ color: '#A3A5A8', marginBottom: 12, fontSize: 13, fontWeight: '500' }}>Theme</Text>
                    <View style={{
                      flexDirection: 'row',
                      backgroundColor: '#1C1E22',
                      borderRadius: 6,
                      ...
                      <TouchableOpacity
                        ...
                        style={{
                          ...
                          justifyContent: 'center',
                          paddingVertical: 8,
                          backgroundColor: !isDark ? '#222528' : 'transparent',
                          borderRadius: 4,
                          borderWidth: !isDark ? 1 : 0,
                          borderColor: '#B4FF3C'
                        }}
                      >
                        <Icon name="sun" size={16} color={!isDark ? '#B4FF3C' : '#A8AAAE'} style={{ marginRight: 6 }} />
                        <Text style={{ color: !isDark ? '#F2F2F2' : '#A8AAAE', fontWeight: !isDark ? '600' : '500', fontSize: 13 }}>Light</Text>
                      </TouchableOpacity>
                      <TouchableOpacity
                        onPress={() => !isDark && toggleTheme()}
                        style={{
                      ...
                      >
                        <Icon name="moon" size={16} color={isDark ? '#B4FF3C' : '#A8AAAE'} style={{ marginRight: 6 }} />
                        <Text style={{ color: isDark ? '#F2F2F2' : '#A8AAAE', fontWeight: isDark ? '600' : '500', fontSize: 13 }}>Dark</Text>
                      </TouchableOpacity>
                    </View>
                  </View>
                </View>
                ...
                {/* Menu Items */}
                <View style={[styles.sectionGroup, { backgroundColor: 'transparent', gap: 8 }]}>
                  <TouchableOpacity
                    style={{
                      flexDirection: 'row',
                      alignItems: 'center',
                      ...
                      borderRadius: 8,
                      backgroundColor: activeTab === 'home' ? '#1D1F23' : '#1A1C1F',
                      borderWidth: 1,
                      borderColor: activeTab === 'home' ? '#B4FF3C' : '#2A2D32',
                      borderLeftWidth: activeTab === 'home' ? 3 : 1,
                      borderLeftColor: activeTab === 'home' ? '#B4FF3C' : '#2A2D32',
                    }}
                    onPress={() => { closeSidebar(); setActiveTab('home'); }}
                  >
                    <View style={{ width: 36, height: 36, borderRadius: 8, backgroundColor: activeTab === 'home' ? 'rgba(180, 255, 60, 0.15)' : '#222528', justifyContent: 'center', alignItems: 'center' }}>
                      <Icon name="home" size={18} color={activeTab === 'home' ? '#B4FF3C' : '#A8AAAE'} />
                    </View>
                    <Text style={{ marginLeft: 14, color: activeTab === 'home' ? '#F2F2F2' : '#E8E8E8', fontSize: 14, fontWeight: activeTab === 'home' ? '600' : '500' }}>Home</Text>
                    {activeTab === 'home' && <View style={{ marginLeft: 'auto', width: 8, height: 8, borderRadius: 4, backgroundColor: '#B4FF3C' }} />}
                  </TouchableOpacity>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => { closeSidebar(); router.push('/doctor-profile'); }}
                  >
                    ...
                    <Text style={{ marginLeft: 14, color: '#E8E8E8', fontSize: 14, fontWeight: '500' }}>Profile</Text>
                  </TouchableOpacity>
                  ...
                  <TouchableOpacity
                    style={{
                      ...
                      paddingHorizontal: 16,
                      borderRadius: 8,
                      backgroundColor: activeTab === 'appointments' ? '#1D1F23' : '#1A1C1F',
                      borderWidth: 1,
                      borderColor: activeTab === 'appointments' ? '#B4FF3C' : '#2A2D32',
                      borderLeftWidth: activeTab === 'appointments' ? 3 : 1,
                      borderLeftColor: activeTab === 'appointments' ? '#B4FF3C' : '#2A2D32',
                    }}
                    onPress={() => { closeSidebar(); setActiveTab('appointments'); }}
                  >
                    <View style={{ width: 36, height: 36, borderRadius: 8, backgroundColor: activeTab === 'appointments' ? 'rgba(180, 255, 60, 0.15)' : '#222528', justifyContent: 'center', alignItems: 'center' }}>
                      <Icon name="file" size={18} color={activeTab === 'appointments' ? '#B4FF3C' : '#A8AAAE'} />
                    </View>
                    <Text style={{ marginLeft: 14, color: activeTab === 'appointments' ? '#F2F2F2' : '#E8E8E8', fontSize: 14, fontWeight: activeTab === 'appointments' ? '600' : '500' }}>History</Text>
                    {activeTab === 'appointments' && <View style={{ marginLeft: 'auto', width: 8, height: 8, borderRadius: 4, backgroundColor: '#B4FF3C' }} />}
                  </TouchableOpacity>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => { closeSidebar(); router.push('/edit-doctor-profile'); }}
                  >
                    <View style={{ width: 36, height: 36, borderRadius: 8, backgroundColor: '#222528', justifyContent: 'center', alignItems: 'center' }}>
                      <Icon name="edit" size={18} color="#A8AAAE" />
                    </View>
                    <Text style={{ marginLeft: 14, color: '#E8E8E8', fontSize: 14, fontWeight: '500' }}>Author</Text>
                  </TouchableOpacity>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => { closeSidebar(); router.push('/notifications-settings'); }}
                  >
                    <View style={{ width: 36, height: 36, borderRadius: 8, backgroundColor: '#222528', justifyContent: 'center', alignItems: 'center' }}>
                      <Icon name="bell" size={18} color="#A8AAAE" />
                    </View>
                    <Text style={{ marginLeft: 14, color: '#E8E8E8', fontSize: 14, fontWeight: '500' }}>Notifications</Text>
                  </TouchableOpacity>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => { closeSidebar(); router.push('/help-support'); }}
                  >
                    <View style={{ width: 36, height: 36, borderRadius: 8, backgroundColor: '#222528', justifyContent: 'center', alignItems: 'center' }}>
                      <Icon name="infoCircle" size={18} color="#A8AAAE" />
                    </View>
                    <Text style={{ marginLeft: 14, color: '#E8E8E8', fontSize: 14, fontWeight: '500' }}>Help</Text>
                  </TouchableOpacity>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => { closeSidebar(); router.push('/doctor-settings'); }}
                  >
                    <View style={{ width: 36, height: 36, borderRadius: 8, backgroundColor: '#222528', justifyContent: 'center', alignItems: 'center' }}>
                      <Icon name="cog" size={18} color="#A8AAAE" />
                    </View>
                    <Text style={{ marginLeft: 14, color: '#E8E8E8', fontSize: 14, fontWeight: '500' }}>Setting</Text>
                  </TouchableOpacity>
                </View>

              </View>
              {/* Logout */}
              <View style={{ paddingTop: 12, marginTop: 'auto', marginBottom: 20, borderTopWidth: 1, borderTopColor: '#222528' }}>
                <TouchableOpacity
                  style={{
                    flexDirection: 'row',
                    alignItems: 'center',
                  ...
                  onPress={() => { closeSidebar(); handleLogout(); }}
                >
