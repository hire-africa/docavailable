...
export default function BlogArticle3() {
  ...
  const handleShare = async () => {
    try {
      await Share.share({
        message: 'Check out this great article from DocAvailable: The Future of Healthcare: Telemedicine and AI',
        url: 'https://docavailable.com/blog/future-healthcare-telemedicine-ai',
      });
    } catch (error) {
