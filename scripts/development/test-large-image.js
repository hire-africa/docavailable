...
async function testLargeImage() {
    try {
        console.log('🧪 Testing Doctor Registration with Large Image...\n');

        // This is a much larger base64 encoded JPEG image (about 2KB)
        const largeImageBase64 = 'data:image/jpeg;base64,';
