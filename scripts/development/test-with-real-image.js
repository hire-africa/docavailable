...
async function testWithRealImage() {
    try {
        console.log('🧪 Testing Doctor Registration with Real Image...\n');

        // This is a proper base64 encoded 100x100 pixel JPEG image
        const realImageBase64 = 'data:image/jpeg;base64,';
        ...
        formData.append('profile_picture', realImageBase64);
        formData.append('national_id', realImageBase64);
        formData.append('medical_degree', realImageBase64);
        formData.append('medical_licence', realImageBase64);
