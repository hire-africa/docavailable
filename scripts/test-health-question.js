// Test script to verify health questions get appropriate guidance
...
console.log('🧪 Testing health question responses...\n');
...
async function testHealthQuestions() {
  const testInputs = [
    "I have a headache",
...
Remember: For greetings, just be friendly and casual. Save the app features and medical guidance for actual health questions.`
      ...
      // Check for medical disclaimers in health question responses
      ...
      if (hasMedicalDisclaimer) {
        console.log('✅ Medical disclaimer found in health response');
      } else {
        console.log('⚠️  No medical disclaimer in health response');
      }
      
      // Check for app features in health question responses
      ...
      if (hasAppFeatures) {
        console.log('✅ App features mentioned in health response');
      } else {
        console.log('⚠️  No app features in health response');
      }
  ...
  console.log('\n🎉 Health question test completed!');
}

// Run the test
testHealthQuestions().catch(console.error);
