...
export const environment = {
  ...
  // WebRTC Configuration (Fixed URLs with correct port - using localhost for testing)
  WEBRTC_SIGNALING_URL: getEnvVar('EXPO_PUBLIC_WEBRTC_SIGNALING_URL', 'ws://localhost:8080/audio-signaling'),
  WEBRTC_CHAT_SIGNALING_URL: getEnvVar('EXPO_PUBLIC_WEBRTC_CHAT_SIGNALING_URL', 'ws://localhost:8080/chat-signaling'),
